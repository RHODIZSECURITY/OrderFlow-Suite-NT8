...
namespace NinjaTrader.NinjaScript.Indicators
{
	...
	{
		private OrderFlow_Suite_RHODIZ_v1_0_0.MarketVolume[] cacheMarketVolume;
		public OrderFlow_Suite_RHODIZ_v1_0_0.MarketVolume MarketVolume(_MarketVolumeEnums.Calculation _marketVolumeCalculation, int _period)
		{
			return MarketVolume(Input, _marketVolumeCalculation, _period);
		}

		public OrderFlow_Suite_RHODIZ_v1_0_0.MarketVolume MarketVolume(ISeries<double> input, _MarketVolumeEnums.Calculation _marketVolumeCalculation, int _period)
		{
			...
			return CacheIndicator<OrderFlow_Suite_RHODIZ_v1_0_0.MarketVolume>(new OrderFlow_Suite_RHODIZ_v1_0_0.MarketVolume(){ _MarketVolumeCalculation = _marketVolumeCalculation, _Period = _period }, input, ref cacheMarketVolume);
		}
	}
}
...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.OrderFlow_Suite_RHODIZ_v1_0_0.MarketVolume MarketVolume(_MarketVolumeEnums.Calculation _marketVolumeCalculation, int _period)
		{
			return indicator.MarketVolume(Input, _marketVolumeCalculation, _period);
		}

		public Indicators.OrderFlow_Suite_RHODIZ_v1_0_0.MarketVolume MarketVolume(ISeries<double> input , _MarketVolumeEnums.Calculation _marketVolumeCalculation, int _period)
		{
			return indicator.MarketVolume(input, _marketVolumeCalculation, _period);
		}
	}
